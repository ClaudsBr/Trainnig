...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Testando o Método Abastecer
		System.out.println(v1.getLitrosCombustivel()+" litros");
		v1.abastecer(33);
		System.out.println(v1.getLitrosCombustivel()+" litros");
		System.out.println("----------------------------------");
		
		//Testando o método frear
		...
		System.out.println("O carro está ligado?"+ v1.isLigado());
		v1.desligar();
		System.out.println("O carro está ligado?"+ v1.isLigado());
		v1.ligar();
		System.out.println("O carro está ligado?"+ v1.isLigado());
		...
		System.out.println("O carro está ligado? "+ v1.isLigado());
		v1.setVelocidade(50);
		//Testando o Método Ligar com o carro em Movimento
		v1.desligar();
